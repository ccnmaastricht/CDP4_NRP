...
#include "gazebo_ros_logical_camera/ARIAC.hh"
#include "gazebo_ros_logical_camera/LogicalCameraImage.h"
...
void ROSLogicalCameraPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->imagePub = this->rosnode->advertise<gazebo_ros_logical_camera::LogicalCameraImage>(imageTopic_ros, 1, false);
...
void ROSLogicalCameraPlugin::OnImage(ConstLogicalCameraImagePtr &_msg)
{
  ...
  gazebo_ros_logical_camera::LogicalCameraImage imageMsg;
...
void ROSLogicalCameraPlugin::AddModelToMsg(
  ...
  gazebo_ros_logical_camera::LogicalCameraImage & imageMsg)
{
  gazebo_ros_logical_camera::Model modelMsg;
